...
{
with instance_create(x,y,Bullet2)
{motion_add(point_direction(x,y,joy_x   ,joy_y)+random(40)-4,16+random(6))
image_angle = direction}
}
...
{
with instance_create(x,y,Bullet2)
{motion_add(point_direction(x,y,mouse_x,mouse_y)+random(50)-4,16+random(6))
image_angle = direction}
}
...
{
with instance_create(x,y,Bullet2)
{motion_add(point_direction(x,y,joy_x   ,joy_y)+random(50)-4,16+random(6))
image_angle = direction}
}
...
{
with instance_create(x,y,Bullet2)
{motion_add(point_direction(x,y,mouse_x,mouse_y)+random(30)-4,16+random(6))
image_angle = direction}
}
...
{
with instance_create(x,y,Bullet2)
{motion_add(point_direction(x,y,joy_x   ,joy_y)+random(30)-4,16+random(6))
image_angle = direction}
}
...
with instance_create(x,y,MeltingBullet)
{motion_add(point_direction(x,y,mouse_x,mouse_y)+random(8)-4,16)
image_angle = direction}
